...
export default function FloatingContactButtons() {
  return (
    <aside className="floating-contact-container" aria-label="Direct Contact Shortcuts">
      ...
      <a
        href="https://wa.me/919820171740?text=Hello%20Jubilant%20Steels,%20I%20am%20interested%20in%20your%20products"
        target="_blank"
        rel="noopener noreferrer"
        className="floating-btn whatsapp-btn"
        aria-label="Direct WhatsApp chat with Jubilant Steels"
        title="Chat on WhatsApp (+91 9820171740)"
      >
      ...
      <a
        href="tel:+919820171740"
        className="floating-btn phone-btn"
        aria-label="Call Jubilant Steels Export Desk"
        title="Call +91 9820171740"
      >
        <span className="floating-btn-glow" aria-hidden="true" />
